...
The goal of the implementation is to efficiently save the bot's strength such that the highest score cells will be attacked first. A greedy approach was used for achieving this functionality.
